...
const profileSchema = Yup.object().shape({
	...
	anak_ke: Yup.number().nullable().optional(),
...
export default function ProfileEdit() {
	...
	return (
		<div className="mt-4 w-[60%] h-full">
			...
			<div className="flex flex-col w-full items-center ml-5">
				<div className="w-[85px] border relative h-[85px] rounded-full bg-red-200 ">
				...
				<Formik initialValues={initialState} validationSchema={profileSchema} enableReinitialize>
