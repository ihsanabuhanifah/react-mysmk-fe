...
import FilterRekap from "./filterHalaqoh";
import { encodeURlFormat } from "../../../utils";
import usePage from "../../../hook/usePage";

import { downloadRekapAbsensi } from "../../../api/guru/absensi";
import useDownload from "../../../hook/useDownload";
import { listRekapHalaqoh } from "../../../api/guru/halaqoh";
export default function RekapHalaqoh() {
  ...
  let { data, isLoading } = useQuery(
    //query key
    ["rekap_absensi_halaqoh", params],
    //axios function,triggered when page/pageSize change
    () => listRekapHalaqoh(params),
    //configuration
    {
        ...
        <Table celled selectable>
          <Table.Header>
            <Table.Row>
              ...
              <Table.HeaderCell>Nama Pengampu</Table.HeaderCell>
              <Table.HeaderCell>Status Kehadiran</Table.HeaderCell>
              <Table.HeaderCell>Dari Surat </Table.HeaderCell>
              <Table.HeaderCell>Dari Ayat</Table.HeaderCell>
              <Table.HeaderCell>Sampai Surat </Table.HeaderCell>
              <Table.HeaderCell>Sampai Ayat</Table.HeaderCell>
