                  ...
                  {values?.data?.map((value, index) => {
                    return (
                      <>
                        ...
                        <div className="grid grid-cols-1 gap-x-5 gap-y-2 p-5 shadow-md">
                          ...
                          <section>
                            ...
                            <PlaceholderParagraph className="font-bold">
                              Dzikir
                            </PlaceholderParagraph>
                          </section>
                          ...
                          <div className="grid grid-cols-1 gap-y-2">
                            ...
                            <Form.Checkbox
                              control={Checkbox}
                              label="Sudah Sholat Shubuh"
                            />
                            <Form.Checkbox
                              control={Checkbox}
                              label="Sudah Sholat Dzuhur"
                            />
                            <Form.Checkbox
                              control={Checkbox}
                              label="Sudah Sholat Ashar"
                            />
                            <Form.Checkbox
                              control={Checkbox}
                              label="Sudah Sholat Magrib"
                            />
                            <Form.Checkbox
                              control={Checkbox}
                              label="Sudah Sholat Isya"
                            />
                            <section className="grid grid-cols-1 gap-y-2">
                              ...
                              <Form.Checkbox
                                control={Checkbox}
                                label="Sudah Membaca Al Quran 1 Juz"
                              />
                            </section>
                          </div>
                        </div>
