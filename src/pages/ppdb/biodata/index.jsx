...
export default function ProfilePpdb() {
		...
		<LayoutPpdb title="My Profile">
			<div className="flex h-full w-full">
				<div className="flex flex-col bg-white border-r border-black/5 h-full w-[185px] ml-2">
					...
					<ButtonLink title="Password & Security" logo={<IoShieldOutline size={22} className={`${pathname === "/ppdb/biodata/security" ? 'text-[#18a558]' : 'text-gray-400'}`} />} to="/ppdb/biodata/security" />
				</div>
