            ...
            <main className="bg-imageAbstrak object-cover min-h-screen overflow-hidden">
              <div className="text-center">
                <Form onSubmit={handleSubmit}>
                  {currentCard === 1 && (
                    <div className="card p-6 border rounded shadow-lg mx-auto my-4 bg-white w-full max-w-[1237px] h-[498px] sm:px-4">
                      ...
                      <div className="flex justify-between mb-4 mt-4">
                        <Link to={"/ppdb/dashboard"}>
                          <button className="bg-btnCustom text-white p-4 w-[150px] rounded-lg">
                            Back
                          </button>
                        </Link>
                        <Button
