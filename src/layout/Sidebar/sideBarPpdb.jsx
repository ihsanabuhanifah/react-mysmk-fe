...
import { getProfileCalonSantri } from "../../api/ppdb/profile"; // Pastikan import dari path yang benar
      ...
      <div className="flex mb-3 items-center bg-[#18a558] mr-2 gap-x-2 rounded-lg p-2">
        <div className="w-10 h-10 rounded-full bg-gray-200">
          <img
            ...
            src={CalonSantriProfile?.profilePicture || ProfileImage}
            alt="Profile"
          />
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-md text-white font-black leading-none">
            {CalonSantriProfile?.nama_siswa?.split(" ")[0]}
          </p>
        </div>
      </div>
