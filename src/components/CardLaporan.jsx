...
const Card = ({ item }) => {
  ...
  return (
    <div className="hover:shadow-md w-full">
        ...
        >
          <div className="flex gap-5 items-center w-full">
            ...
            <Image
              ...
              className={`w-32 h-32 rounded-xl bg-cover flex-shrink-0 transition-opacity duration-500 ${isImageLoaded ? "opacity-100" : "opacity-0"
                }`}
