...
export const LabelStatus = ({ status }) => {
	if (status === 'open') {
		return <Label size="tiny" content="Belum Dikerjakan" color="purple" as={'a'} />
	}
	if (status === 'progress') {
		return <Label size="tiny" content="Sedang Dikerjakan" color="blue" as={'a'} />
	}
	if (status === 'finish') {
		return <Label size="tiny" content="Selesai Dikerjakan" color="green" as={'a'} />
	}
	if (status === 'harian') {
	...
	if (status === 'tugas') {
		return <Label size="tiny" content="Tugas Sekolah" color="yellow" as={'a'} />
	}
...
export const LabelDurasi = ({ status }) => {
	...
	return <Label size="tiny" content={result?.[0]?.text || '-'} color="brown" as={'a'} />
}
